#!/usr/bin/env python3
"""
Complete 1 Maccabees from 4:61 onwards
"""
...
if __name__ == "__main__":
    # Process 1 Maccabees from 4:61 onwards
    source_file = '/Users/suganolab/web/bibleweb/public/static/html/norm/1maccabees.htm'
    ruby_file = '/Users/suganolab/web/bibleweb/public/static/html/ruby/1maccabees.htm'
    
    print("Getting verses from 4:61 onwards...")
    verses = get_verses_from_source(source_file, 4, 61)
    ...
    if verses:
        ...
        print("1 Maccabees conversion completed!")