#!/usr/bin/env python3
"""
Append remaining verses to ruby files
"""
...
if __name__ == "__main__":
    # Process 2 Maccabees from 4:27 onwards
    source_file = '/Users/suganolab/web/bibleweb/public/static/html/norm/2maccabees.htm'
    ruby_file = '/Users/suganolab/web/bibleweb/public/static/html/ruby/2maccabees.htm'
    
    print("Getting verses from 4:27 onwards...")
    verses = get_verses_from_source(source_file, 4, 27)
    ...
    if verses:
        ...
        print("2 Maccabees conversion completed!")